...
- **Serverless**
  ...
  - [Apache OpenWhisk](docs/en/latest/plugins/openwhisk.md): seamless integration with Apache OpenWhisk as a dynamic upstream to proxy all requests for a particular URI to the to your own OpenWhisk cluster.
